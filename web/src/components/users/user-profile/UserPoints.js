...
export default function UserPoints() {
  ...
  return (
    <div className="d-flex flex-column justify-content-center align-items-start px-5">
      ...
      <div className={`alert w-100 ${user?.points > 5 ? 'bg-light-pink' : 'outline-pink-box'}`}>
      ...
      <div className={`alert w-100 ${user?.points > 1 ? 'bg-light-pink' : 'outline-pink-box'}`}>
      ...
      <div className={`alert w-100 ${user?.points > 50 ? 'bg-light-pink' : 'outline-pink-box'}`}>
      ...
      <div className={`alert w-100 ${user?.points > 150 ? 'bg-light-pink' : 'outline-pink-box'}`}>
      ...
      <div className={`alert w-100 ${user?.points > 300 ? 'bg-light-pink' : 'outline-pink-box'}`}>
