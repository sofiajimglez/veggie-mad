      ...
      <div className='flex flex-wrap items-center justify-between mx-auto p-4'>
        ...
        <div className='flex items-baseline md:order-2 gap-4'>
          ...
          <div className='relative hidden md:block'>
            ...
            <input type='text' className='block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500' placeholder='Buscar...' />
          </div>
        ...
        <div className='items-baseline justify-between hidden w-full md:flex md:w-auto md:order-1'>
          ...
          <div className='relative mt-3 md:hidden'>
            ...
            <input type='text' className='block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50' placeholder='Search...' />
          </div>
